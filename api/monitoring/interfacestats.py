...
class InterfaceStats(object):
    ...
    def getStatsRawData(self, statsquerystring):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface"
    ...
    def getPostAggregationDataByQuery(self, statsquerystring):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/aggregation"
        response = self.client.apiCall(HttpMethods.POST, endpoint, statsquerystring)
        return response
    ...
    def getPostAggregationAppDataByQuery(self, statsquerystring):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/app-agg/aggregation"
        response = self.client.apiCall(HttpMethods.POST, endpoint, statsquerystring)
        return response


    def getBandwidthDistribution(self):
        """
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/ccapacity/distribution"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getCountPost(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/doccount"
    ...
    def getStatDataFields(self):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/fields"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getPostStatBulkRawData(self, statsquerystring, scrollId, count):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/page?scrollId={scrollId}&count={count}"
        response = self.client.apiCall(HttpMethods.POST, endpoint, statsquerystring)
        return response
    ...
    def getStatQueryFields(self):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/interface/query/fields"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response


    def getStatisticsPerInterface(self, query):
        """
