...
class VPN(object):
    ...
    def get(self):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/template/policy/list/vpn"
    ...
    def preview(self, policylist):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/template/policy/list/vpn/preview"
        response = self.client.apiCall(HttpMethods.POST, endpoint, policylist)
        return response
    ...
    def previewById(self, id):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/template/policy/list/vpn/preview/{id}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getListsById(self, id):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/template/policy/list/vpn/{id}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
