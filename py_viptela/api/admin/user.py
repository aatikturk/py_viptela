...
def createColoGroup(vmanage, colocationgroup):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/admin/cologroup"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, colocationgroup)
    return response
...
def editColoGroup(vmanage, colocationgroup, id):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, colocationgroup)
    return response
...
def createResourceGroup(vmanage, createagroup):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/admin/resourcegroup"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, createagroup)
    return response
...
def switchView(vmanage, groupView):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, groupView)
    return response
...
def editResourceGroup(vmanage, updategroupdescription, groupId):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, updategroupdescription)
    return response
...
def createUser(vmanage, user):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/admin/user"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, user)
    return response
...
def validatePassword(vmanage, userpassword):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, userpassword)
    return response
...
def updatePassword(vmanage, user, userName):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, user)
    return response
...
def removeSessions(vmanage, user):
    ...
    response = vmanage.client.apiCall(HttpMethods.DELETE, endpoint, user)
    return response
...
def createUserGroup(vmanage, usergroup):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/admin/usergroup"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, usergroup)
    return response
...
def updateUserGroup(vmanage, usergroup, userGroupId):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, usergroup)
    return response
...
def createVpnGroup(vmanage, vpngroup):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/admin/vpngroup"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, vpngroup)
    return response
...
def editVpnGroup(vmanage, vpngroup, id):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, vpngroup)
    return response
