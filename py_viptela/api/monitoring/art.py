def getStatDataRawData(vmanage, query):
    ...
    endpoint = f"dataservice/statistics/art?query={query_string}"
...
def getStatsRawData(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/art"
...
def getAggregationDataByQuery(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/art/aggregation?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getPostAggregationDataByQuery(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/art/aggregation"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getPostAggregationAppDataByQuery(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/art/app-agg/aggregation"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getStatDataRawDataAsCSV(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/art/csv?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getCount(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/art/doccount?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getCountPost(vmanage, query):
    ...
    endpoint = f"dataservice/statistics/art/doccount"
...
def getStatDataFields(vmanage):
    ...
    endpoint = f"dataservice/statistics/art/fields"
    response = vmanage.apiCall("GET", endpoint)
    return response
def getStatBulkRawData(vmanage, query, scrollId, count):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/art/page?query={query_string}&scrollId={scrollId}&count={count}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getPostStatBulkRawData(vmanage, statsquerystring, scrollId, count):
    ...
    endpoint = f"dataservice/statistics/art/page?scrollId={scrollId}&count={count}"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getStatQueryFields(vmanage):
    ...
    endpoint = f"dataservice/statistics/art/query/fields"
    response = vmanage.apiCall("GET", endpoint)
    return response
