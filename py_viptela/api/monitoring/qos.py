def getStatDataRawData(vmanage, query):
    ...
    endpoint = f"dataservice/statistics/qos?query={query_string}"
...
def getStatsRawData(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/qos"
...
def getAggregationDataByQuery(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/qos/aggregation?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getPostAggregationDataByQuery(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/qos/aggregation"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getPostAggregationAppDataByQuery(vmanage, statsquerystring):
    ...
    endpoint = f"dataservice/statistics/qos/app-agg/aggregation"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getStatDataRawDataAsCSV(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/qos/csv?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getCount(vmanage, query):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/qos/doccount?query={query_string}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getCountPost(vmanage, query):
    ...
    endpoint = f"dataservice/statistics/qos/doccount"
...
def getStatDataFields(vmanage):
    ...
    endpoint = f"dataservice/statistics/qos/fields"
    response = vmanage.apiCall("GET", endpoint)
    return response
def getStatBulkRawData(vmanage, query, scrollId, count):
    ...
    """
    query_string = vmanage.builder.generateQuery(query)
    endpoint = f"dataservice/statistics/qos/page?query={query_string}&scrollId={scrollId}&count={count}"
    response     = vmanage.apiCall("GET", endpoint)
    return response
def getPostStatBulkRawData(vmanage, statsquerystring, scrollId, count):
    ...
    endpoint = f"dataservice/statistics/qos/page?scrollId={scrollId}&count={count}"
    response = vmanage.apiCall("POST", endpoint, statsquerystring)
    return response
def getStatQueryFields(vmanage):
    ...
    endpoint = f"dataservice/statistics/qos/query/fields"
    response = vmanage.apiCall("GET", endpoint)
    return response
