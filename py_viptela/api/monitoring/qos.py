...
class QoS(object):
    ...
    Implements GET POST DEL PUT methods for QoS endpoints
    ...
    def getStatDataRawData(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/qos?query={query}"
    ...
    def getAggregationDataByQuery(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/qos/aggregation?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getStatDataRawDataAsCSV(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/qos/csv?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getCount(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/qos/doccount?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getStatBulkRawData(self, query, scrollId, count):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/qos/page?query={query}&scrollId={scrollId}&count={count}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
