...
class WlanClient(object):
    ...
    def getStatDataRawData(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/wlanclientinfo?query={query}"
    ...
    def getAggregationDataByQuery(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/wlanclientinfo/aggregation?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getStatDataRawDataAsCSV(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/wlanclientinfo/csv?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getCount(self, query):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/wlanclientinfo/doccount?query={query}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
    ...
    def getStatBulkRawData(self, query, scrollId, count):
        ...
        endpoint = f"https://{self.host}:{self.port}/dataservice/statistics/wlanclientinfo/page?query={query}&scrollId={scrollId}&count={count}"
        response = self.client.apiCall(HttpMethods.GET, endpoint)
        return response
