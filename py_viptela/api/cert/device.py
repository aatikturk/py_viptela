...
def getCertDetails(vmanage, parsecert):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, parsecert)
    return response
...
def forceSyncRootCert(vmanage, singedcertificate):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, singedcertificate)
    return response
...
def installCertificate(vmanage, singedCert):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, singedCert)
    return response
...
def updateJks(vmanage, updatejks):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, updatejks)
    return response
...
def decommissionEnterpriseCSRForVedge(vmanage, revokingcsrforhardwarevedge):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, revokingcsrforhardwarevedge)
    return response
...
def saveRootCertChain(vmanage, rootChain):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, rootChain)
    return response
