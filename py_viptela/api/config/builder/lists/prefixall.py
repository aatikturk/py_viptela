def getListsForAllPrefixes(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/ipprefixall"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/ipprefixall/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/ipprefixall/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/ipprefixall/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
