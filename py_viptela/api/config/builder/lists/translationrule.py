def get(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/translationrules"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/translationrules/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/translationrules/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/translationrules/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
