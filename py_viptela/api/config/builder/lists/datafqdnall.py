def getAllDataPrefixAndFQDNLists(vmanage):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixfqdn"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixfqdn/preview"
    response = vmanage.client.apiCall(vmanage.POST, endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixfqdn/preview/{id}"
    response = vmanage.client.apiCall(vmanage.GET, endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixfqdn/{id}"
    response = vmanage.client.apiCall(vmanage.GET, endpoint)
    return response
