...
def getListsForAllDataPrefixes(vmanage):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixall"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixall/preview"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixall/preview/{id}"
    response = vmanage.client.apiCall(HttpMethods.GET, endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/dataprefixall/{id}"
    response = vmanage.client.apiCall(HttpMethods.GET, endpoint)
    return response
