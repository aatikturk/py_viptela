def get(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/modempassthrough"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/modempassthrough/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/modempassthrough/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/modempassthrough/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
