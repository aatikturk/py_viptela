def get(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/aspath"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/aspath/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/aspath/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/aspath/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
