def get(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/translationprofile"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/translationprofile/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/translationprofile/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/translationprofile/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
