def getDefinitions(vmanage):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap"
...
def saveInBulk(vmanage, policydefinition):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap/bulk"
...
def editMultiple(vmanage, policydefinition, id):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap/multiple/{id}"
    response = vmanage.apiCall("PUT", endpoint, policydefinition)
    return response
...
def preview(vmanage, policydefinition):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap/preview"
    response = vmanage.apiCall("POST", endpoint, policydefinition)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def get(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/definition/qosmap/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
