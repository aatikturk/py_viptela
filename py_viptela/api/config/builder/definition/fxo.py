def getDefinitions(vmanage):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport"
...
def saveInBulk(vmanage, policydefinition):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport/bulk"
...
def editMultiple(vmanage, policydefinition, id):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport/multiple/{id}"
    response = vmanage.apiCall("PUT", endpoint, policydefinition)
    return response
...
def preview(vmanage, policydefinition):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport/preview"
    response = vmanage.apiCall("POST", endpoint, policydefinition)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def get(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/definition/fxoport/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
