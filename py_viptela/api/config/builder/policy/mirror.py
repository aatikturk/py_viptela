...
def getLists(vmanage):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/mirror"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/mirror/preview"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/mirror/preview/{id}"
    response = vmanage.client.apiCall(HttpMethods.GET, endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/mirror/{id}"
    response = vmanage.client.apiCall(HttpMethods.GET, endpoint)
    return response
