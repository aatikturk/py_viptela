def getLists(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/mirror"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/mirror/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/mirror/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/mirror/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
