def getLists(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/umbrelladata"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/umbrelladata/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/umbrelladata/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/umbrelladata/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
