def getLists(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/appprobe"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/appprobe/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/appprobe/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/appprobe/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
