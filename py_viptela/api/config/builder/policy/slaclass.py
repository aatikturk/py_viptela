def getLists(vmanage):
    ...
    endpoint = f"dataservice/template/policy/list/sla"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"dataservice/template/policy/list/sla/preview"
    response = vmanage.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/sla/preview/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"dataservice/template/policy/list/sla/{id}"
    response = vmanage.apiCall("GET", endpoint)
    return response
