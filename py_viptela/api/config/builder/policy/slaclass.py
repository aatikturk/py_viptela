def getLists(vmanage):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/sla"
...
def preview(vmanage, policylist):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/sla/preview"
    response = vmanage.client.apiCall("POST", endpoint, policylist)
    return response
...
def previewById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/sla/preview/{id}"
    response = vmanage.client.apiCall("GET", endpoint)
    return response
...
def getListsById(vmanage, id):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/template/policy/list/sla/{id}"
    response = vmanage.client.apiCall("GET", endpoint)
    return response
