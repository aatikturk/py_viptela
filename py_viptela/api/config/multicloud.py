...
def validateAccountAdd(vmanage, account):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, account)
    return response
...
def updateEdgeAccount(vmanage, account, accountId):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/accounts/edge/{accountId}"
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, account)
    return response
...
def audit(vmanage, audit):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, audit)
    return response
...
def createCgw(vmanage, cg):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, cg)
    return response
...
def updateCgw(vmanage, cloudgateway, cgName):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/cloudgateway/{cgName}"
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, cloudgateway)
    return response
...
def TunnelScaling(vmanage, siteinformation, cgName):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, siteinformation)
    return response
...
def attachSites(vmanage, siteinformation, cgName):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/cloudgateway/{cgName}/site"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, siteinformation)
    return response
...
def detachSites(vmanage, siteinformation, cgName):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/cloudgateway/{cgName}/site"
    response = vmanage.client.apiCall(HttpMethods.DELETE, endpoint, siteinformation)
    return response
...
def updateEdgeConnectivity(vmanage, edgeconnectivity):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, edgeconnectivity)
    return response
...
def createEdgeConnectivity(vmanage, edgeconnectivity):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/connectivity/edge"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, edgeconnectivity)
    return response
...
def createConnectivityGateway(vmanage, connectivitygateway):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, connectivitygateway)
    return response
...
def createIcgw(vmanage, interconnectgateway):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, interconnectgateway)
    return response
...
def updateIcgw(vmanage, gatewayInfo, edgeGatewayName):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/gateway/edge/{edgeGatewayName}"
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, gatewayInfo)
    return response
...
def editTag(vmanage, vpctag):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, vpctag)
    return response
...
def hostvpcTagging(vmanage, vpctag):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/hostvpc/tags"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, vpctag)
    return response
...
def processMapping(vmanage, vpcmapping):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, vpcmapping)
    return response
...
def updateEdgeGlobalSettings(vmanage, globalsetting):
    ...
    response = vmanage.client.apiCall(HttpMethods.PUT, endpoint, globalsetting)
    return response
...
def addEdgeGlobalSettings(vmanage, globalsetting):
    ...
    endpoint = f"https://{vmanage.host}:{vmanage.port}/dataservice/multicloud/settings/edge/global"
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, globalsetting)
    return response
...
def telemetry(vmanage, telemetry):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, telemetry)
    return response
...
def createVirtualWan(vmanage, virtualwan):
    ...
    response = vmanage.client.apiCall(HttpMethods.POST, endpoint, virtualwan)
    return response
